...
import com.choicespropertysolutions.desta.AllImages;
...
public class AllImagesFetchList {private static Context context;
    ...
    public AllImagesFetchList(AllImages allImages) {
        this.context = allImages;
    }

    public static List allImagesFetchList(final List<AllImagesListItems> allImageListItem, final RecyclerView.Adapter adapter, String categoryOfPhoto, String userId, int current_page, final ProgressDialog progressDialog) {
        method = "showPhotoDetails";
        format = "json";
        idOfUser = userId;
...
//                                    userVoteList.setVoteListId(userVoteListId);
                        ...
                        try {
                            jsonArray = response.getJSONArray("showPhotoDetailsResponse");
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    try {
                                        ...
                                        AllImagesListItems allImagesListItems = new AllImagesListItems();
                                        allImagesListItems.setImagePath(obj.getString("photoPath"));
                                        allImagesListItems.setPhotoListId(obj.getString("photoId"));
                                        allImagesListItems.setImageCategory(obj.getString("photoCategory"));
                                        allImageListItem.add(allImagesListItems);
