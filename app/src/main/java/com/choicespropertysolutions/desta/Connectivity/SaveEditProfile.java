...
public class SaveEditProfile {
    ...
    private static String idOfUseer;
    ...
    public static String uploadEditedDetails(String name, String phone, String newPhone,String email, String newEmail, String state,String userId) throws Exception {
        method = "editProfile";
        format = "json";
        username = name;
        useroldphone  = phone;
    ...
    public static void returnResponse(String response) {
        ...
        if (response.equals("USERS_DETAILS_EDITED")) {
            ...
            sessionManager.createUserLoginSession(idOfUseer, username, userstate,userphone,userEmail);
